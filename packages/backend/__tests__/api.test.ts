...
export interface ICategory {
  ...
  createdBy: Serialize<mongoose.Types.ObjectId, string> & RefTo<{}>;
  isActive: boolean;
  createdAt: Date;
  updatedAt: Date;
  deletedAt?: Date;
...
import { buildGetHandler } from "generate-handler";

const getCategories = buildGetHandler(Category, { $addFields: { total: [] } });
