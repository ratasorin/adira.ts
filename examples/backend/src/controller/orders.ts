...
const getOrders = buildGetHandler<IOrder>(Order);
const createOrder = buildPostHandler<IOrder>(Order);
const updateOrder = buildPatchHandler<IOrder>(Order);
const deleteOrder = buildDeleteHandler<IOrder>(Order);
