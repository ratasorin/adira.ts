...
export type ExampleApiTypes = {
    "/api/users": {
        ...
        "POST": {
            RequestParams: any;
            RequestBody: Backend.InferRequestBody<CreateUserFn>;
    ...
    id: string;
            ...
            RequestBody: Backend.InferRequestBody<UpdateUserFn>;
    ...
    "/api/categories": {
        ...
        "POST": {
            RequestParams: any;
            RequestBody: Backend.InferRequestBody<CreateCategoryFn>;
    ...
    id: string;
            ...
            RequestBody: Backend.InferRequestBody<UpdateCategoryFn>;
    ...
    "/api/products": {
        ...
        "POST": {
            RequestParams: any;
            RequestBody: Backend.InferRequestBody<CreateProductFn>;
    ...
    id: string;
            ...
            RequestBody: Backend.InferRequestBody<UpdateProductFn>;
    ...
    "/api/orders": {
        ...
        "POST": {
            RequestParams: any;
            RequestBody: Backend.InferRequestBody<CreateOrderFn>;
    ...
    id: string;
            ...
            RequestBody: Backend.InferRequestBody<UpdateOrderFn>;
